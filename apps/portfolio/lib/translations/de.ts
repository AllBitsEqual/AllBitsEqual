const de = {
  ...
  projectsPage: {
    ...
    items: [
      ...
      },
      {
        ...
        teaser: 'Entwicklung einer React-Native-Plattform für Social Sharing und Wohltätigkeitsinitiativen — mit GoodNews als Inhaltsquelle für positive Beiträge und BetterPlace als Datenbasis für Spendenflows. Ein fokussierter Sprint, der beweist, dass gute Architektur und gute Absichten kein Widerspruch sind.',
        accent: 'teal' as const,
        visible: true,
      },
      {
      ...
      },
      {
        ...
        period: '2006 – 2011',
        partners: ['Agenturen', 'Einzelkunden'],
  ...
  contact: {
    title: 'Kontakt',
    subtitle: 'Ob Projektanfrage, Frage oder einfach Hallo — ich lese jede Nachricht und antworte, wenn ich kann.',
