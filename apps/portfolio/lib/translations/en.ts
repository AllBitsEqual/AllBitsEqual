const en = {
  ...
  contact: {
    title: 'Get in Touch',
    subtitle: "Whether you have a project in mind, a question, or just want to say hello — I read every message and reply when I can.",
    submit: 'Send Message',
    sending: 'Sending…',
    successTitle: 'Message sent.',
    successBody: "Thanks for reaching out. I'll get back to you as soon as I can.",
